...
public class PostControllerDocsTest extends RestDocsSecuritySupport {
    ...
    void getFavoriteList() throws Exception {
        ...
        mockMvc.perform(
                RestDocumentationRequestBuilders.get("/api/v1/post/{postId}/favorite-list", postId))
            .andExpect(status().isOk())
            .andDo(print())
    ...
    private static PostDetailResponseDto createPostDetailResponse(Long boardNumber,
