...
public class CommentControllerDocsTest extends RestDocsSecuritySupport {
            ...
            .andDo(document("comments-create",
                ...
                relaxedRequestFields(
                    fieldWithPath("postId").type(JsonFieldType.NUMBER)
                        .description("Post Id"),
                    fieldWithPath("commentId").type(JsonFieldType.NUMBER).optional()
            ...
            .andDo(document("comments-getChildComments",
                ...
                responseFields(
                    ...
                    fieldWithPath("data.commentListResponse").type(JsonFieldType.ARRAY)
                        .description("댓글 목록"),
                    fieldWithPath("data.commentListResponse[0].commentId").type(
                    ...
                    fieldWithPath("data.commentListResponse[0].profileImage").type(
                            JsonFieldType.STRING)
                        .description("댓글 작성자 프로필 이미지 URL"),
                    fieldWithPath("data.commentListResponse[0].createdAt").type(
                            JsonFieldType.STRING)
                        .description("댓글 생성일자"),
                    fieldWithPath("data.commentListResponse[0].updatedAt").type(
                            JsonFieldType.STRING)
                        .description("댓글 수정일자"),
                    fieldWithPath("data.commentListResponse[0].childCount").type(
                            JsonFieldType.NUMBER)
    ...
    void getChildComments() throws Exception {
        ...
        mockMvc.perform(
                get("/api/v1/comments/post/{postId}/parentId/{parentId}", postId, commentId))
            .andExpect(status().isOk())
